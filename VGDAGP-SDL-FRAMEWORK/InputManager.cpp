...
namespace SDLFramework {
	...
	bool InputManager::MouseButtonPressed(MouseButton button) {
		...
		//Making sure that our mask is NOT in our previous state
		//And making sure it IS in our current state
	...
	bool InputManager::MouseButtonReleased(MouseButton button) {
		...
		//Making sure that our mask IS in our previous state
		//And making sure it is NOT in our current state
		return (mPrevMouseState & mask) && !(mMouseState & mask);
	}
